...
></div>
                  ...
                  <p className="value-text"> <Droplet size={18} color="#e63946" style={{ marginRight: '6px' }} />DBP:  {patientData.bp_diastolic} hg</p>
                </div>
              </>
            ) : (
          ...
          <ul className="history-list">
            ...
            <li><FileText size={18} color="#3498db" style={{ marginRight: '1px' }} /> Pre_Report_1_250511.pdf <span>Just now</span></li>
          ...
          <ul className="history-list">
            <li style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }} >
              <div>
              < Bell size={18} color="#FACC15" style={{ marginRight: '6px' }} /> <strong>Paracetamol</strong> <span>May 10, 2025, 10:00 AM</span>
              </div>
              <a
                href="#"
                onClick={(e) => {
                  e.preventDefault();
                  setRefillMedicineName('Paracetamol');
                  setShowStores(true);
                }}
                style={{
                  fontSize: '0.85rem',
        ...
        <div className="store-list">
          <h3 className="store-title"><img src={medstock} alt="Logo" className="store-logo" />
           Stores</h3>
          ...
          <div className="store-cards-container">
            {Object.entries(storeMedicineData)
              .filter(([storeName, storeData]) =>
                storeData.medicines.some(
              ...
              .map(([storeName]) => (
                <div
                  key={storeName}
                  className={`store-card ${selectedStore === storeName ? 'selected' : ''}`}
                ...
                {storeMedicines.map((med, index) => (
                  <li key={index} className="medicine-item">
                    <div className="medicine-details">
                      ...
                      <p>{med.description}</p>
                      <span className="medicine-price"> <DollarSign size={16} color="#28a745" style={{ marginRight: '5px' }} /> {med.price}</span>
                    </div>
                    <button
          ...
          {showPaymentForm && selectedMedicine && (
            <div className="payment-form">
              ...
              <p> <DollarSign size={16} color="#28a745" style={{ marginRight: '5px' }} />  Price: {selectedMedicine.price}</p>
